...
export function createResultsList(flights = []) {
  if (flights.length === 0) {
    return `
      <section class="mx-auto mt-6 max-w-5xl rounded border border-dashed border-slate-300 bg-white p-6 text-center">
  ...
  return `
    <section class="mx-auto mt-6 grid max-w-5xl gap-4">
      <div>
